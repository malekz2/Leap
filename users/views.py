...
def register(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            user = form.save()
            # Get the profile associated with the new user
            profile = Profile.objects.get(user=user)
            # Update the profile fields
            profile.teach = form.cleaned_data.get('teach')
            profile.learn = form.cleaned_data.get('learn')
            profile.bio = form.cleaned_data.get('bio')
            profile.google_form_url = form.cleaned_data.get('google_form_url')
            profile.save()
